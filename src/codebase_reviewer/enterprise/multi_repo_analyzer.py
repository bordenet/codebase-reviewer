    ...
    def get_aggregate_metrics(self) -> AggregateMetrics:
        ...
        if not self.repo_analyses:
            return AggregateMetrics(
                total_repos=0, total_issues=0, total_critical=0, total_high=0,
                total_medium=0, total_low=0, total_security=0, total_quality=0,
                total_files=0, total_lines=0, avg_issues_per_repo=0.0,
                worst_repo=None, best_repo=None
            )
