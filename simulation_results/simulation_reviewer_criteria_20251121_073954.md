...
- **Match Status**: ✅ Match / ⚠️ Partial / ❌ Mismatch

## Component Validation
For each claimed component:
- **Component Name**: [From documentation]
- **Status**: ✅ Found / ❌ Missing / ⚠️ Partial
...
## Recommendations
1. [Specific action items to align code and documentation]
2. [Architecture improvements if needed]

**Example:**
```
## Component Validation
- **DocumentationAnalyzer**: ✅ Found at `src/analyzers/documentation.py`
- **CacheLayer**: ❌ Missing (claimed in README but not implemented)
- **APIGateway**: ⚠️ Partial (exists but uses Flask instead of documented FastAPI)
```
...
{'claimed_architecture': {'pattern': 'microservices', 'layers': ['service', 'repository'], 'components': ['Core', 'DocumentationAnalyzer', 'CodeAnalyzer', 'ValidationEngine', 'PromptGenerator']}, 'actual_structure': {'languages': [{'name': 'Python', 'percentage': 20.99}, {'name': 'Shell', 'percentage': 2.34}], 'frameworks': ['Flask', 'Django'], 'entry_points': [], 'main_modules': ['review_codebase.egg-info', 'codebase_reviewer'], 'packages': ['src/codebase_reviewer', 'src/codebase_reviewer/analyzers', 'src/codebase_reviewer/prompts'], 'file_counts': {'python': 27, 'packages': 3, 'modules': 2}, 'sample_files': ['setup.py', 'tests/test_basic.py', 'tests/test_workflow_executor.py', 'tests/test_workflow_loader.py', 'src/codebase_reviewer/simulation.py', 'src/codebase_reviewer/web.py', 'src/codebase_reviewer/models.py', 'src/codebase_reviewer/prompt_generator.py', 'src/codebase_reviewer/__init__.py', 'src/codebase_reviewer/cli.py', 'src/codebase_reviewer/orchestrator.py', 'src/codebase_reviewer/__main__.py', 'src/codebase_reviewer/analyzers/documentation.py', 'src/codebase_reviewer/analyzers/constants.py', 'src/codebase_reviewer/analyzers/code.py']}, 'validation_results': [{'status': 'valid', 'evidence': "Detected frameworks: ['Flask', 'Django']", 'recommendation': 'Architecture pattern appears consistent'}, {'status': 'partial', 'evidence': 'Found 0/5 claimed components', 'recommendation': 'Review documented component list for accuracy'}]}
```
...
{'repository_path': '.', 'test_files': ['tests/test_basic.py', 'tests/test_workflow_executor.py', 'tests/test_workflow_loader.py'], 'test_file_count': 3, 'test_frameworks': ['pytest'], 'test_organization': {'tests': ['test_basic.py', 'test_workflow_executor.py', 'test_workflow_loader.py']}, 'has_tests': True}
```
...
{'repository_path': '.', 'files_analyzed': 27, 'logging_imports_count': 1, 'files_with_logging': [], 'files_with_print': [{'file': 'tests/test_basic.py', 'count': 7}, {'file': 'src/codebase_reviewer/simulation.py', 'count': 12}, {'file': 'src/codebase_reviewer/web.py', 'count': 3}, {'file': 'src/codebase_reviewer/orchestrator.py', 'count': 1}], 'files_with_exception_handling': [{'file': 'src/codebase_reviewer/web.py', 'count': 7}, {'file': 'src/codebase_reviewer/prompt_generator.py', 'count': 1}, {'file': 'src/codebase_reviewer/cli.py', 'count': 9}, {'file': 'src/codebase_reviewer/analyzers/documentation.py', 'count': 1}, {'file': 'src/codebase_reviewer/analyzers/language_detector.py', 'count': 3}, {'file': 'src/codebase_reviewer/analyzers/quality_checker.py', 'count': 2}, {'file': 'src/codebase_reviewer/analyzers/dependency_parser.py', 'count': 1}, {'file': 'src/codebase_reviewer/prompts/template_loader.py', 'count': 6}, {'file': 'src/codebase_reviewer/prompts/generator.py', 'count': 6}, {'file': 'src/codebase_reviewer/prompts/workflow_executor.py', 'count': 2}], 'has_structured_logging': True, 'print_vs_logging_ratio': 'N/A (no logging)'}
```
...
{'total_commits_analyzed': 38, 'hotspot_files': [{'file': 'src/codebase_reviewer/prompt_generator.py', 'change_count': 14}, {'file': 'src/codebase_reviewer/cli.py', 'change_count': 12}, {'file': 'src/codebase_reviewer/prompts/phase0.py', 'change_count': 10}, {'file': 'src/codebase_reviewer/prompts/phase1.py', 'change_count': 10}, {'file': 'src/codebase_reviewer/prompts/phase2.py', 'change_count': 10}, {'file': 'src/codebase_reviewer/prompts/generator.py', 'change_count': 8}, {'file': 'src/codebase_reviewer/prompts/template_loader.py', 'change_count': 8}, {'file': 'src/codebase_reviewer/orchestrator.py', 'change_count': 8}, {'file': 'src/codebase_reviewer/web.py', 'change_count': 8}, {'file': 'src/codebase_reviewer/prompts/phase3.py', 'change_count': 8}, {'file': 'src/codebase_reviewer/prompts/phase4.py', 'change_count': 8}, {'file': 'tests/test_workflow_executor.py', 'change_count': 6}, {'file': 'tests/test_workflow_loader.py', 'change_count': 6}, {'file': 'src/codebase_reviewer/prompts/__init__.py', 'change_count': 6}, {'file': 'src/codebase_reviewer/analyzers/code.py', 'change_count': 6}], 'bug_fix_commit_count': 13, 'refactor_commit_count': 5, 'recent_commit_messages': ['Clean up temporary files', 'Fix isort and mypy issues in prompt improvements', 'Improve prompt quality based on simulation analysis', 'Fix template loading for reviewer_criteria workflow', 'Fix formatting in simulation.py to pass CI', 'Implement LLM simulation system for prompt testing and tuning', 'Rename principal_engineer workflow to reviewer_criteria', 'Phase 4: Add workflow management API endpoints', 'Fix black and isort formatting in Phase 3 files', 'Phase 3: Add workflow execution engine with progress tracking']}
```
